...
using FIL;
    ...
    public partial class frmReportPromotionStatus : Form
    {
        ...
        public frmReportPromotionStatus(ReportDocument pdocument = null)
        {
            InitializeComponent();
            if (pdocument != null)
            {
        ...
        private void btnViewReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                path = Application.StartupPath + "/rpt/Production/rptPromotionStatus.rpt";
               
                document.Load(path);
                DataTable dtReport = new DataTable();
                dtReport = managePromotion.GetReportPromotionStatus(Convert.ToDateTime(dtpFromDate.Text), Convert.ToDateTime(dtpToDate.Text), txtFOrder.Text, txtTOrder.Text, txtFromCustomerCode.Text, txtToCustomerCode.Text);
