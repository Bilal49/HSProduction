...
public partial class frmReportProductFormulaWithAmount : Form
{
    ...
    public frmReportProductFormulaWithAmount(ReportDocument pdocument = null)
    {
        InitializeComponent();
        if (pdocument != null)
        {
    ...
    private void btnViewReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string path = Application.StartupPath + "/rpt/Production/rptProductFormulaWithAmount.rpt";
            document.Load(path);
            DataTable dtReport = new DataTable();
            dtReport = manageProduct.GetReportProductFormulaWithAmount(Convert.ToInt32(cmbProductFormulaNew.EditValue));
    ...
    private void cmbProductFormulaNew_Enter(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            BeginInvoke(new MethodInvoker(() => { cmbProductFormulaNew.SelectAll(); }));
        }
