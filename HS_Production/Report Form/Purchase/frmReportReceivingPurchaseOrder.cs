...
using FIL;
    ...
    public partial class frmReportReceivingPurchaseOrder : Form
    {
        ...
        public frmReportReceivingPurchaseOrder(ReportDocument pdocument = null)
        {
            InitializeComponent();
            if (pdocument != null)
            {
        ...
        private void btnViewReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtReport = managePurchaseOrder.GetReceivingPurchaseOrderReport(Convert.ToDateTime(dtpFromDate.Text), Convert.ToDateTime(dtpToDate.Text), txtFOrder.Text, txtTOrder.Text, txtFromVendorCode.Text, txtToVendorCode.Text, -1);
