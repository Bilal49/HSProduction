...
using FIL;
    ...
    public partial class frmReportReceivingPOSummary : Form
    {
        ...
        public frmReportReceivingPOSummary(bool IsDetailReport)
        {
            InitializeComponent();
        ...
        private void btnViewReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Please Select Vendor Name", "Vendor Name Required", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                if (DetailReport)
                {
                    ...
                    path = Application.StartupPath + "/rpt/Purchaserpt/rptReceivingPOSummary.rpt";
                }
                else
                {
                    //Yeh Just Simple Summary List Report hai for RPO.
                    path = Application.StartupPath + "/rpt/Purchaserpt/rptReceivingPOSummaryList.rpt";

                }
                
                document.Load(path);
                DataTable dtReport = new DataTable();
                dtReport = managePurchaseOrder.GetReceivingPOSummaryReport(Convert.ToDateTime(dtpFromDate.Text), Convert.ToDateTime(dtpToDate.Text), txtFOrder.Text, txtTOrder.Text, txtFromVendorCode.Text, DetailReport);
