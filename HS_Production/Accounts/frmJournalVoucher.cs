...
public partial class frmJournalVoucher : Form
{
    ...
    public frmJournalVoucher(string pVoucherType)
    {
        InitializeComponent();
    ...
    private void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtReport = manageAccount.GetReportVoucher(txtJVCode.Text, txtJVCode.Text, dtpVoucher.Value, dtpVoucher.Value, this.VoucherType);
